...
void DialogSetCustomFeatureOption::OnButtonGet(void)
{
    ...
    CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Task_Get_Feature_Option(m_str_id, &option_blur, &option_thre_upper, &option_thre_lower, &option_kernel_size) ;
...
void DialogSetCustomFeatureOption::OnButtonSet(void)
{
    ...
    CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Task_Set_Feature_Option(m_str_id, option_blur, option_thre_upper, option_thre_lower, option_kernel_size) ;
