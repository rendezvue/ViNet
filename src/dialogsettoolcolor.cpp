...
void DialogSetToolColor::OnButtonGetRedHistogramImage(void)
{
	...
	const int image_type = IMAGE_RGB888 ;
    //int get_image_type = 0 ;
    CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Histogram_GetImage(GetId(), 0/*red*/, image_type, &image_buf)  ;
...
void DialogSetToolColor::OnButtonGetGreenHistogramImage(void)
{
	...
	const int image_type = IMAGE_RGB888 ;
    //int get_image_type = 0 ;
    CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Histogram_GetImage(GetId(), 1/*green*/, image_type, &image_buf)  ;
...
void DialogSetToolColor::OnButtonGetBlueHistogramImage(void)
{
	...
	const int image_type = IMAGE_RGB888 ;
    //int get_image_type = 0 ;
    CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Histogram_GetImage(GetId(), 2/*blue*/, image_type, &image_buf)  ;
...
{
	int check_color_elem = CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Histogram_UseElement(GetId())  ;
...
void DialogSetToolColor::OnButtonSetUseRed(bool checked)
{
	...
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_UseElement(GetId(), color_elem)  ;
...
void DialogSetToolColor::OnButtonGetRedHistogramRange(void)
{
	...
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Histogram_Range(GetId(), HISTOGRAM_USE_RED, &out_min, &out_max)  ;
...
{	
	...
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_Range(GetId(), HISTOGRAM_USE_RED, f_min, f_max)  ;
...
{
	int out_min=0, out_max=0 ;
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Histogram_Range(GetId(), HISTOGRAM_USE_GREEN, &out_min, &out_max)  ;
...
void DialogSetToolColor::OnButtonSetGreenHistogramRange(void)
{
	...
	float f_min = (float)min / 255.0 ;
	float f_max = (float)max / 255.0 ;
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_Range(GetId(), HISTOGRAM_USE_GREEN, f_min, f_max)  ;
...
{
	int out_min=0, out_max=0 ;
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Histogram_Range(GetId(), HISTOGRAM_USE_BLUE, &out_min, &out_max)  ;
...
void DialogSetToolColor::OnButtonSetBlueHistogramRange(void)
{
	...
	float f_min = (float)min / 255.0 ;
	float f_max = (float)max / 255.0 ;
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_Range(GetId(), HISTOGRAM_USE_BLUE, f_min, f_max)  ;
        ...
        if( m_i_set_color>=0)
        {
            ...
            if( m_i_set_color == HISTOGRAM_USE_RED )
            {
				...
				if( m_i_e_value > m_i_s_value)
				{
					...
					if( f_min < f_max )
					{
						CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_Range(GetId(), m_i_set_color, f_min, f_max) ;
					}
					else
					{
						CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Histogram_Range(GetId(), m_i_set_color, f_max, f_min) ;
					}			
...
{
	int base_pixel_count = CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Base_Pixel_Count(GetId()) ;
...
void DialogSetToolColor::OnButtonGetTolerance(void)
{
	...
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Get_Tolerance(GetId(), &tol_min, &tol_max) ;
...
void DialogSetToolColor::OnButtonSetTolerance(void)
{
	...
	CEnsemble::getInstance()->GetSelectDevice()->Ensemble_Tool_Option_InspectColor_Set_Tolerance(GetId(), min, max) ;
